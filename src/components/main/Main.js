import { useDataQuery, useDhis2ConnectionStatus } from '@dhis2/app-runtime'
...
export const Main = () => {
    ...
    const handleSaveorUpdateRecord = async (action, data) => {
        ...
        console.log(selectedProgramName.displayName);
                                ...
                                <div className={classes.main}>                
                                        ...
                                        <div style={{ display: 'flex', marginTop: '5px' }}>
                                            <div>
                                                <Button 
                                                    ...
                                                    disabled={!(selectedOU.length > 0 && selectedAttr.length > 0 && selectedProgram.length > 0)}
                                                    >                                                        
                                    ...
                                    <div className={classes.panelRight}>
                                        <span style={{fontWeight:'bold' }}>
                                                ...
                                                >
                                                    {i18n.t('Add or Remove Attribute in Duplicate Checker')}
